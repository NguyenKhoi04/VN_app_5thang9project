//Danh mục đọc - Lớp 2 Tuần 3 Bài 5+6
        ...
        <View style={styles.imageGrid}>
          <View style={styles.imageRow}>
            <TouchableOpacity
              activeOpacity={0.8}
              onPress={() =>
                navigation.navigate('ReadingPronunciation_bai5_week3' as never)
              }
            >
              <Image
            ...
            <TouchableOpacity
              activeOpacity={0.8}
              onPress={() =>
                navigation.navigate('ReadingPronunciation_bai6_week3' as never)
              }
            >
              <Image
                source={require("@/assets/images/lop2/bai6_lop2.png")}
                style={styles.imageBox}
                resizeMode="cover"
              />
            </TouchableOpacity>
