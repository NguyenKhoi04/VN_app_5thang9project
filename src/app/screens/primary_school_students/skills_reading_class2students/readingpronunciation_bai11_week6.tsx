...
export default function ReadingPronunciation_bai11_week6Screen() {
  const params = useLocalSearchParams<{
    ho_ten?: string;
    ten_ky_nang?: string;
  }>();
  const [name, setName] = useState(params.ho_ten || "");
  const [tenBaiHoc] = useState("Cái trống trường em");
  ...
  const AUDIO_MAP: Record<string, any> = {
    doc_mau: require("../../../../../text-to-speech/speech_docmau_bai11_week6.wav"),
    // doan1: require("../../../../../text-to-speech/speech_doan1_bai11_week6.wav"),
    // doan2: require("../../../../../text-to-speech/speech_doan2_bai11_week6.wav"),
    // doan3: require("../../../../../text-to-speech/speech_doan3_bai11_week6.wav"),
    // doan4: require("../../../../../text-to-speech/speech_doan4_bai11_week6.wav"),
    // cau_hoi_1: require("../../../../../text-to-speech/speech_cauhoi1_bai11_week6.wav"),
    // dap_an_1: require("../../../../../text-to-speech/speech_dapan1_bai11_week6.wav"),
    // cau_hoi_2: require("../../../../../text-to-speech/speech_cauhoi2_bai11_week6.wav"),
    // dap_an_2: require("../../../../../text-to-speech/speech_dapan2_bai11_week6.wav"),
    // cau_hoi_3: require("../../../../../text-to-speech/speech_cauhoi3_bai11_week6.wav"),
    // dap_an_3: require("../../../../../text-to-speech/speech_dapan3_bai11_week6.wav"),
  };
  ...
  const renderMode1 = () => (
    <View style={styles.storyBox}>
      ...
      <Text style={styles.title}>Cái trống trường em</Text>
      ...
      <Text style={styles.author}>(Thanh Hào)</Text>
    </View>
  );
    ...
    <View>
      ...
      <View style={styles.questionSection}>
        ...
        <View style={styles.questionBlock}>
          ...
          <View style={styles.questionBox}>
            <Text style={styles.questionText}>
              Trong những ngày hè, cái trống trường như thế nào?
            </Text>
          </View>
          ...
          {showAnswer1 && (
            <View style={styles.answerBox}>
              <Text style={styles.answerContent}>
                Suốt ba tháng hè, cái trống cũng được nghỉ, nằm im lìm trên giá
                ngẫm nghĩ vì vắng bóng các bạn học sinh.
              </Text>
        ...
        <View style={styles.questionBlock}>
          ...
          <View style={styles.questionBox}>
            <Text style={styles.questionText}>
              Khi bước vào năm học mới, tâm trạng của cái trống ra sao?
            </Text>
          </View>
          ...
          {showAnswer2 && (
            <View style={styles.answerBox}>
              <Text style={styles.answerContent}>
                Thấy các bạn học sinh quay trở lại, trống rất mừng vui và cất
                giọng "Tùng! Tùng! Tùng! Tùng!" rộn rã tưng bừng.
              </Text>
        ...
        <View style={styles.questionBlock}>
          ...
          <View style={styles.questionBox}>
            <Text style={styles.questionText}>
              Bài thơ thể hiện tình cảm của bạn nhỏ với cái trống trường như thế
              nào?
            </Text>
          </View>
          ...
          {showAnswer3 && (
            <View style={styles.answerBox}>
              <Text style={styles.answerContent}>
                Bạn nhỏ coi cái trống như một người bạn thân thiết, luôn thấu
                hiểu, gắn bó và cùng sẻ chia niềm vui đến trường.
              </Text>
