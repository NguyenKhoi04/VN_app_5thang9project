    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        <View style={styles.imageGrid}>
          <View style={styles.imageRow}>
            <TouchableOpacity
              activeOpacity={0.8}
              onPress={() =>
                navigation.navigate("ReadingWeekDetailsClass1week1" as never)
              }
            >
              <Image
            ...
            <TouchableOpacity
              activeOpacity={0.8}
              onPress={() =>
                navigation.navigate("ReadingWeekDetailsClass1week3" as never)
              }
            >
              <Image
          ...
          <View style={styles.imageRow}>
            <TouchableOpacity
              activeOpacity={0.8}
              onPress={() =>
                navigation.navigate("ReadingWeekDetailsClass1week5" as never)
              }
            >
              <Image
        ...
        <TouchableOpacity
          activeOpacity={0.8}
          onPress={() =>
            navigation.navigate("ReadingTopicDetails_Topic1Class1Screen" as never)
          }
        >
          <Image
