// Phần 2 - Bài 4: Luyện tập tổng hợp
...
const Phan2Bai4: React.FC<Props> = ({ navigation }) => (
  <SkillMenuScreen navigation={navigation} lessonTitle="Luyện tập tổng hợp" lessonSubtitle="Comprehensive Practice" lessonNumber={4} themeColor={THEME} skills={skills} onBack={() => navigation.goBack()} />
);
export default Phan2Bai4;
