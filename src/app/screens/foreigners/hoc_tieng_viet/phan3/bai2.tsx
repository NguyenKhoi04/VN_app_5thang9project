// Phần 3 - Bài 2: CÔ LÀ NGƯỜI NƯỚC NÀO?
...
const Phan3Bai2: React.FC<Props> = ({ navigation }) => (
  <SkillMenuScreen navigation={navigation} lessonTitle="CÔ LÀ NGƯỜI NƯỚC NÀO?" lessonSubtitle="Where are you from?" lessonNumber={2} themeColor={THEME} skills={skills} onBack={() => navigation.goBack()} />
);
export default Phan3Bai2;
