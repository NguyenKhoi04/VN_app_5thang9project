// Phần 1 - Bài 4: Tập viết chữ - 6 kỹ năng
...
const Phan1Bai4: React.FC<Props> = ({ navigation }) => (
  <SkillMenuScreen
    navigation={navigation}
    lessonTitle="Tập viết chữ"
    lessonSubtitle="Writing Practice"
