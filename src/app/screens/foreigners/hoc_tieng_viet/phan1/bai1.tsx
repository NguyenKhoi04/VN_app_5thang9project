// Phần 1 - Bài 1: Bảng chữ cái - 6 kỹ năng
...
const skills: SkillItem[] = [
  ...
  {
    id: 2,
    title: 'Nghe và lập lại',
    subtitle: 'Listen and Repeat',
    emoji: '👂',
    screenName: 'SkillNgheLapLai',
  },
  {
    id: 3,
    title: 'Tập đọc',
  ...
  },
  {
    ...
    subtitle: 'Grammar',
    emoji: '📐',
    screenName: 'SkillNguPhap',
  },
  {
    id: 5,
    title: 'Nhận diện và thay thế',
    subtitle: 'Recognition and Substitution',
    emoji: '🔄',
    screenName: 'SkillNhanDien',
  },
  {
    id: 6,
    title: 'Viết chính tả',
    subtitle: 'Dictation Writing',
    emoji: '✍️',
    screenName: 'SkillChinhTa',
  },
];
...
const Phan1Bai1: React.FC<Props> = ({ navigation }) => (
  <SkillMenuScreen
    ...
    lessonSubtitle="The Vietnamese Alphabet"
